-- Cranfield GIN+tsvector Baseline - Insert Loading
-- Creates GIN index on EMPTY table, then loads data via inserts
-- Measures insert performance into an already-indexed table

\set ON_ERROR_STOP on
\timing on

\echo 'Cranfield GIN Baseline - Insert Load Phase'
\echo '============================================'
...
-- Create the GIN target table with index
...
-- Insert data into indexed GIN table
\echo 'INSERT_TIME:'
\echo 'Inserting data into indexed GIN table...'
...
\echo 'GIN insert load phase completed.'
