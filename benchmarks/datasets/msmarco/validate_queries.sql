...
--   2. BM25 scores match within tolerance (0.01 absolute difference)
...
BEGIN
    ...
    IF v_failures > 0 THEN
        RAISE NOTICE 'VALIDATION FAILED: % queries with issues', v_failures;
    ELSE
        RAISE NOTICE 'VALIDATION PASSED: All queries validated successfully';
    END IF;
END;
$$;
