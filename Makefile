...
REGRESS = abort aerodocs basic binary_io bmw bmw_skip_advance bulk_load \
	...
	memtable_page memtable_spill memtable_spill_dead memtable_reclaim merge \
	mixed parallel_build parallel_bmw partitioned partitioned_many \
	partial_index pgstats queries quoted_identifiers rescan schema scoring1 \
	scoring2 scoring3 scoring4 scoring5 scoring6 security security_acl segment \
	segment_integrity segment_reclaim tombstone_reuse tombstone_recover strings \
	temp_table text_array text_config unsupported updates vector \
	vector_v1_rejected unlogged_index wand
