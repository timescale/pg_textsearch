...
# Test configuration
REGRESS = aerodocs basic deletion dropped empty_docs index limits manyterms mixed queries scoring1 scoring2 scoring3 scoring4 scoring5 scoring6 strings vector
