...
# Test configuration
REGRESS = aerodocs basic deletion vacuum dropped empty index inheritance limits lock manyterms memory mixed queries schema scoring1 scoring2 scoring3 scoring4 scoring5 scoring6 strings vector
