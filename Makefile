...
# Test configuration
REGRESS = aerodocs basic binary_io bmw compression coverage deletion vacuum dropped empty implicit index inheritance limits lock manyterms memory merge mixed parallel_build parallel_compact partitioned partitioned_many queries schema scoring1 scoring2 scoring3 scoring4 scoring5 scoring6 segment segment_integrity strings unsupported updates vector unlogged_index wand text_config
