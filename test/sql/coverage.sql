...
-- =============================================================================
-- Test 15: Plain text ORDER BY (exercises scan.c sk_subtype == TEXTOID)
-- =============================================================================
...
-- =============================================================================
-- Test 17: Build-mode spill (exercises state.c tp_clear_memtable build path)
-- =============================================================================

-- Create table with enough data to trigger mid-build spill
CREATE TABLE build_spill_test (id serial PRIMARY KEY, content text);
INSERT INTO build_spill_test (content)
SELECT 'buildspill unique term' || i || ' extra words for document ' || i
