...
CREATE INDEX scoring4_bulk_idx ON scoring4_bulk USING pg_textsearch(content)
...
CREATE INDEX scoring4_incr_idx ON scoring4_incr USING pg_textsearch(content)
  WITH (text_config='english', k1=1.2, b=0.75);
