...
WHERE oid = 'compaction_background_target_idx'::regclass;
SELECT d.oid AS db_oid,
       c.oid AS index_oid,
       coalesce(nullif(c.reltablespace, 0), d.dattablespace) AS spc_oid,
       pg_relation_filenode(c.oid) AS relfilenumber,
