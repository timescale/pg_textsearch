...
#define TP_INJECTION_V5_SEGMENT_TOTAL_LEN "pg-textsearch-v5-segment-total-len"
...
#define TP_INJECTION_PARALLEL_VACUUM_LEADER_ESTIMATE \
...
extern uint64 tp_injected_v5_segment_total_len(uint64 total_tokens);
