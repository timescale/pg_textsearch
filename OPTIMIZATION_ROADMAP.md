...
At full scale, we're now **smaller than ParadeDB** (1396 MB vs 1500 MB).  However, ParadeDB is also storing positional information for phrase queries, so numbers are not entirely comparable.
